    ...
    return (
        <div className="main">
            <div className="mainDiv">
                <hl>Welcome to React Fundamentals at Eleven Fifty</hl>
                ...
                <hr />
                <hl>Important Notes</hl>
                <ul>
                    <li>Being component based, you can move on to the next module.</li> <li>
                        The styling is intentionally bland in some spots. Just a sandbox. </li>
